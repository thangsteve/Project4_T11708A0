    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (customersFacade.findByMail(email).size() > 0) {
            ...
            String content = "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n"
                    ...
                    + "\n"
                    + "                            <a href=\"http://localhost:8080/Bigmobiles/getLinkresetPasswordServlet?resetCode=" + number + "\"\">http://localhost:8080/Bigmobiles/getLinkresetPasswordServlet?resetCode=" + number + "</a>\n"
                    + "\n"
                    + "                            <br/><br/>\n"
                    + "\n"
            ...
            request.getRequestDispatcher("https://mail.google.com").forward(request, response);
        } else {
