(function(i) {
            ...
            if (i.isPlainObject(c)) {
                ...
                if (w) {
                    ...
                    for (e = n.length; g < e; g++)
                        h = c.createAttribute(n[g].name.replace(":", "_dt_b_namespace_token_")),
    ...
    function K(a, b) {
        ...
        for (var f = 0, g = a.body.length; f < g; f++)
            ...
            }), c = c[0].length) : c = c.length, c > d && (d = c), 40 < d)
                return 52;
        d *= 1.3;
        return 6 < d ? d : 6
    }
        ...
        var x = h.document.createElementNS("http://www.w3.org/1999/xhtml", "a"),
                ...
                F = function(a, b, d) {
                    ...
                    if (L)
                        ...
                        f || (f = (h.URL || h.webkitURL || h).createObjectURL(a)), d ? h.location.href = f : h.open(f, "_blank") || (h.location.href = f), c.readyState = c.DONE, g(), D(f)
                },
                m = F.prototype;
            ...
            H = function(a, b) {
                for (var d = G(b), c = a.buttons.exportData(b.exportOptions), f = b.fieldBoundary,
                    ...
                    for (var c = "", b = 0, d = a.length; b < d; b++)
                        0 < b && (c += g), c += f ? f + ("" + a[b]).replace(e, n + f) + f : a[b];
                    return c
                }, h = b.header ? i(c.header) + d : "", j = b.footer && c.footer ? d + i(c.footer) : "", k = [], l = 0, m = c.body.length; l < m; l++)
                    k.push(i(c.body[l]));
                return {
                    str: h + k.join(d) + j,
                    rows: k.length
    ...
    o.ext.buttons.excelHtml5 = {
        ...
        action: function(a, b, d, c) {
            ...
            for (var o = 0, u = d.body.length; o < u; o++)
                r(d.body[o], g);
    ...
    o.ext.buttons.pdfHtml5 = {
        ...
        action: function(a, b, d, c) {
            ...
            for (var g = 0, e = d.body.length; g < e; g++)
                f.push(i.map(d.body[g], function(a) {
                    return {
                        text: "string" === typeof a ? a : a + "",
